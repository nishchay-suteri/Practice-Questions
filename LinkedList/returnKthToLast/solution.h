...
class Solution{
    protected:
        ...
        virtual SinglyListNode<int>* returnKthToLast(SinglyListNode<int>*,int) = 0;
        void take_input(int n);
    public:
        virtual void solve(int n,int k) = 0;
};

class BruteForceSolution: public Solution{
    private:
        SinglyListNode<int>* returnKthToLast(SinglyListNode<int>*,int);
    public:
        BruteForceSolution();
