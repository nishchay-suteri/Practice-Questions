...
class Solution{
    protected:
        ...
        virtual SinglyLinkedList<int>* sum_lists() = 0;
        void take_input(int n1,int n2);
    public:
        virtual void solve(int n1,int n2) = 0;
};

class OptimalSolution: public Solution{
    private:
        SinglyLinkedList<int>* sum_lists();
        SinglyLinkedList<int>* sum_lists_helper(SinglyListNode<int>*,SinglyListNode<int>*,int& carry);
    public:
        OptimalSolution();
